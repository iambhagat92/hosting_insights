    ...
    <>
      ...
      <TableOfContents
        items={[
          ...
          { id: "overview", label: "SiteGround Overview" },
        ...
        image={{
          src: "https://images.unsplash.com/photo-1488521787991-ed7fe8633ef5?w=400&h=300&fit=crop",
          alt: "SiteGround premium hosting review",
        }}
      />
